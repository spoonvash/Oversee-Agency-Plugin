...
class Oversee_KB_Importer {
    ...
    public static function clear_all_data() {
        ...
        // Clear options - direct delete to bypass cache
        $wpdb->delete($wpdb->options, ['option_name' => 'oversee_kb_last_sync']);
        $wpdb->delete($wpdb->options, ['option_name' => 'oversee_kb_sync_stats']);
        $wpdb->delete($wpdb->options, ['option_name' => 'oversee_kb_sync_progress']);
        
        // Clear caches
        wp_cache_delete('oversee_kb_last_sync', 'options');
        wp_cache_delete('oversee_kb_sync_stats', 'options');
        wp_cache_delete('oversee_kb_sync_progress', 'options');
        wp_cache_delete('alloptions', 'options');
