...
<head>
    ...
    <style id="oversee-branding-vars">
        :root {
            ...
            --hero-gradient: linear-gradient(135deg, <?php echo esc_attr($branding['secondary_color']); ?> 0%, <?php echo esc_attr(Oversee_Branding::darken_color($branding['secondary_color'], 20)); ?> 100%);
        }
    </style>
